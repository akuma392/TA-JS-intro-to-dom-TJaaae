...
allHrsArray.forEach((num) => (num.style.border = "1px solid tomato"));

// Change the background of all the hr to "antiquewhite" using for of loop.

for (let i of allHrsArray) {
  i.style.backgroundColor = "antiquewhite";
}
...
allHrsArray.forEach((num) => (num.style.border = "dashed"));
...
let rmBox1 = document.getElementsByClassName("box one")[0];

for (let i of rmBox1.childNodes) {
  i.remove();
}
...
document.querySelector(".three").prepend("hello");
...
for (let i = 1; i < allBox.length; i = i + 2) {
  allBox[i].style.backgroundColor = "blue";
}
...
box7.childNodes.forEach((num) => num.remove());
...
imgElm.setAttribute("style", "width:100%;height=100%");
